<ul id = "ulHeader"class="Cerca">
            ...
            <li id = "liNomePagina"><h1>HOME</h1></li><li id = "liSelectEvento"><select><option value="Evento">Evento</option><option value="Artista">Artista</option><option value="Data">Data</option><option value="Città">Città</option></select></li><li id="liCerca"><fieldset form="form1"><input id="inputCerca" type="text" name="username" value="Cerca"></fieldset></li><li id="liLente"   onclick="clickShowSelectCerca();"><a><img src="./img/icone/Lente.png"alt="lente di ingrandimento per la ricerca"/></a></li>
